...
private:
	...
	void _test() {
		...
		addResult(Tests::TestDynamicLookahead<Size, OptimisationType::TwoOpt>(seed, cities, args));
		addResult(Tests::TestDynamicLookaheadConvexHullInserstion<Size, OptimisationType::TwoOpt>(seed, cities, args));
